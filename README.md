...
- Пароль администратора сохраняется в `.secrets/panel.json` в виде PBKDF2-хеша (не в открытом виде).
...
Примечание: если у клиента истек срок и вы продлеваете `expires_at` (или делаете конфиг бессрочным), панель автоматически снова включает этот конфиг.
